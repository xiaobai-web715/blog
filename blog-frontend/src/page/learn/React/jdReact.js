...
import '../../../mock/learn/React/jdReact'
import Css from '../../../assets/css/learn/React/jdReact.css'
...
const JDReact = (props) => {
    ...
    useEffect(() => {
        ...
        request(`${config.path}home/learn/React/1` , 'get').then(res => {
    ...
    return (
        <div className={Css['page']}>
            <div className={Css['page-title']}>京东电商</div>
            <div className={Css['img']}>
                <img src={require(`../../../assets/image/introduction/learn/${title ? title : '京东_react'}.jpg`).default} alt=''></img>
            </div>
            ...
            <div className={Css['more']}>
                <Link to={config.path + `api/learn/more?id=React/1`}><span className={(value  || sessionStorage.getItem('backgroundColor'))  === 'dark' ? Css['active'] : ''}>阅览更多&gt;&gt;</span></Link>
            </div>
        </div>
    )
}

export default JDReact