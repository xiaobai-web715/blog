...
import '../../../mock/learn/React/blog'
import Css from '../../../assets/css/learn/React/blog.css'
...
const Blog = (props) => {
    ...
    useEffect(() => {
        ...
        request(`${config.path}home/learn/React/2` , 'get').then(res => {
    ...
    return (
        <div className={Css['page']}>
            <div className={Css['page-title']}>博客</div>
            <div className={Css['img']}>
                <img src={require(`../../../assets/image/introduction/learn/${title ? title : '博客'}.jpg`).default} alt=''></img>
            </div>
            ...
            <div className={Css['more']}>
                <Link to={config.path + `api/learn/more?id=React/2`}><span className={(value  || sessionStorage.getItem('backgroundColor'))  === 'dark' ? Css['active'] : ''}>阅览更多&gt;&gt;</span></Link>
            </div>
        </div>
    )
}
