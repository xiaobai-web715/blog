...
import Css from '../../../assets/css/learn/JS/lunbotu.css'
import '../../../mock/learn/JS/lunbotu'
...
const Lunbotu = (props) => {
    ...
    useEffect(() => {
        ...
        request('/home/learn/JS/1' , 'get').then(res => {
    ...
    return (
        <div className={Css['page']}>
            <div className={Css['page-title']}>轮播图</div>
            <div className={Css['img']}>
                <img src={require(`../../../assets/image/introduction/learn/${title ? title : '轮播图'}.jpg`).default} alt=''></img>
            </div>
            ...
            <div className={Css['more']}>
                <Link to={config.path + `api/learn/more?id=JS/1`}><span className={(value  || sessionStorage.getItem('backgroundColor'))  === 'dark' ? Css['active'] : ''}>阅览更多&gt;&gt;</span></Link>
            </div>
        </div>
    )
}
